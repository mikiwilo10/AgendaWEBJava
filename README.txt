...
a persistence unit "AgendaJPAPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "AgendaJPA\pom.xml":
...
artifact ("AgendaJPA.war") is already built. You can build
